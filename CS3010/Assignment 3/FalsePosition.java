public class FalsePosition extends Driver
{
	...
	public static double evaluate(double guess1, double guess2)
	{
		...
		{
			//previousCenter = 0;
			center = (guess1*evaluateE1(guess2) - guess2*evaluateE1(guess1)) / (evaluateE1(guess2) - evaluateE1(guess1) );
